...
import { baseUrl } from '../config/_url';
...
export default function Profile() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(`${baseUrl}/api/user/update/${currentUser._id}`, formData, {
        headers: headers
      });
      console.log(res)
  ...
  const handleShowListings = async () => {
    try {
      ...
      const res = await axios.get(`${baseUrl}/api/user/listings/${currentUser._id}`, {
        headers: headers
      });
     console.log("res",res)
  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <p className='text-red-700 mt-5'>
        {!userListings ? 'Error showing listings' : ''}
      </p>
